...
今回使用するボードは MicroPython で動作するマイコンボード「Waveshare RP2040-Zero」(RP2040搭載)です。開発環境は Thonny を使用します。以下の情報を踏まえて Aura 向けのプログラムを作成してください。

## プログラム作成の進め方
- このスレッドの中で、私から Aura の光らせ方について、あなたに以下のように要望を出していきます
  - あなたに大まかな要望を伝えた時は、それを具体化したいくつかの案を提示してください
  - 私が具体案を一つ選び、その詳細な光り方について要望したら、時系列で具体的な動作を説明してください
  - ただし説明の際は、下記プログラムの変数名は出さず、それが意味する内容を伝えてください
  - 私がプログラム作成をお願いしたら、以下の条件を元に python コードを出力してください
